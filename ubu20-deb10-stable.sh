...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Dev > SakhaVPN ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}Sakha VPN® ${NC}${YELLOW}(${NC} ${green} SAKHA⭐ ${NC}${YELLOW})${NC}"
echo -e " © Recode By My Self SAKHA VPN ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/uwais1990/SakhaVPN/ZX/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/uwais1990/SakhaVPN/ZX/REGISTRASI"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/uwais1990/SakhaVPN/ZX/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
